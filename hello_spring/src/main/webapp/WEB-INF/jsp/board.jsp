...
// 		    var str = '';
// 			str+='<tr>';
// 			str+='<td align="center" class="listtd">1</td>';
// 			str+='<td align="center" class="listtd"><a href="">C</a></td>';
// 			str+='<td align="left" class="listtd">2학년&nbsp;</td>';
// 			str+='<td align="center" class="listtd">Y&nbsp;</td>';
// 			str+='<td align="center" class="listtd">기초과목&nbsp;</td>';
// 			str+='<td align="center" class="listtd">관리자&nbsp;</td>';
// 			str+='</tr>';
// 			$("#tb").append(str)
// 		}
// 	});
...
<body
	...
	<form id="listForm" name="listForm" action="/sample/" method="post">
		...
		<div id="content_pop">
			...
			<div id="table">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td align="center" class="listtd"><a href="">${result.SUBJECT}</a></td>
						<td align="left" class="listtd">${result.GRADE}&nbsp;</td>
						<td align="center" class="listtd">${result.USE_YN}&nbsp;</td>
						<td align="center" class="listtd">${result.DESCRIPTION}&nbsp;</td>
						<td align="center" class="listtd">${result.REG_USER}&nbsp;</td>
					</tr>
					</c:forEach>
				</table>
			</div>
			...
			<div id="sysbtn">
				<ul>
					<li><span class="btn_blue_l"> <a href="/regSubject.do">등록</a> <img
							src="/resource/res/img/btn_bg_r.gif" style="margin-left: 6px;"
							alt="" />
					</span></li>
				</ul>
