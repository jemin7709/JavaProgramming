<%@page import="kr.ac.inha.dto.MemberDto"%>
	...
	<div class="container">
		<form name="newMember" class="form-horizontal"
			...
			<div class="form-group  row">
				...
				<div class="col-sm-3">
					<input name="hello" type="text" class="form-control" placeholder="hello" value="<c:out value="${member.HELLO}"/>">
				</div>
			</div>
			<div class="form-group  row">
				<div class="col-sm-offset-2 col-sm-10 ">
					<a href="javascript:fn_updateMember()" class="btn btn-primary">회원수정</a>
					<a href="#" class="btn btn-primary" onclick="deletion()">회원탈퇴</a>
				</div>
			</div>
		</form>	
	</div>
...
<script type="text/javascript">
	...
	function deletion(){
	    if(confirm("탈퇴하시겠습니까?")){
	        location.href = "/member/deleteMember.do?id='${member.ID}'";
	        return true;
	    } else {
	        return false;
	    }
